      ...
      values.forEach((value) => {
        ...
        if (value.n_c !== undefined && value.n_c !== '') {
          value.n_c.forEach((ncit, index) => {
            ...
            tmp.syn.push(tmp.pvc[index] !== '' && syns[tmp.pvc[index]] ? syns[tmp.pvc[index]].syns : []);
            tmp.aprop.push(tmp.pvc[index] !== '' && syns[tmp.pvc[index]] && syns[tmp.pvc[index]].aprop !== undefined ? syns[tmp.pvc[index]].aprop : []);
          });
        }
        entry.syns.push(tmp);
      });
