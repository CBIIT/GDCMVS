...
let tmpl = '<div class="container table__container"><div class="table__thead row">'
  ...
  +'<div class="col-xs-9">'
    +'<div class="table__thead row">'
      +'<div class="table__th col-xs-6">Matched GDC Values <a class="table__tooltip" data-toggle="tooltip" data-placement="bottom" title="Values that are found in the GDC dictionary and may be successfully submitted for the corresponding property."><i class="fa fa-info-circle"></i></a></div>'
      +'<div class="table__th col-xs-6">CDE Permissible Values <a class="table__tooltip" data-toggle="tooltip" data-placement="bottom" title="For GDC dictionary properties that have a corresponding caDSR clinical data element (CDE), these values are part of that CDE\'s value domain in the caDSR. They may not currently be available in the GDC dictionary."><i class="fa fa-info-circle"></i></a></div>'
    +'</div>'
  +'</div>'
+'</div>'
                      ...
                      +'{{for i_rows}}'
                        +'<div class="row">'
                          +'<div class="col-lg-3 col-xs-12">'
                            +'{{* if((/^C[1-9]/g).test(data.pvc)) { }}<a class="table-td-link" href="javascript:ncitDetails(\'{{:pvc}}\');">{{:pvc}}</a> (NCIt)'
