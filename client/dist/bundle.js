...
let tmpl = '<div class="container table-container"><div class="table-thead row">'
  ...
  +'<div class="col-xs-9">'
    +'<div class="row table-thead">'
      +'<div class="table-th col-xs-6">Matched GDC Values <a class="tooltip-box" data-toggle="tooltip" data-placement="bottom" title="Values that are found in the GDC dictionary and may be successfully submitted for the corresponding property."><i class="fa fa-info-circle"></i></a></div>'
      +'<div class="table-th col-xs-6">CDE Permissible Values <a class="tooltip-box" data-toggle="tooltip" data-placement="bottom" title="For GDC dictionary properties that have a corresponding caDSR clinical data element (CDE), these values are part of that CDE\'s value domain in the caDSR. They may not currently be available in the GDC dictionary."><i class="fa fa-info-circle"></i></a></div>'
    +'</div>'
  +'</div>'
+'</div>'
