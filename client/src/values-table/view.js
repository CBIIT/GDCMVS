      ...
      +'{{else}}'
        ...
        +'{{if i_c !== undefined }}'
          ...
          +'<div class="row">'
              +'<div class="col-xs-10">'
                ...
                +'</div>'
              +'</div>'
              +'<div class="col-xs-2 table__center">{{if n_t.length }}<a href="#" class="table__toggle" aria-label="expand" title="expand" aria-expanded="false"><i class="fa fa-plus"></i></a>{{/if}}</div>'
          +'</div>'
        ...
        +'{{else}}'
          ...
          +'<div class="row">'
            ...
            +'</a></div>'
            +'<div class="col-xs-2 table__center">{{if s.length }}<a href="#" class="table__toggle" aria-label="expand" title="expand" aria-expanded="false"><i class="fa fa-plus"></i></a>{{/if}}</div>'
          +'</div>'
          +'<div class="data-content table__td" style="display: none;">'
            +'<div class="row">'
              +'<div class="col-xs-4">'
