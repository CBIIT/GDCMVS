  ...
  header: '<div class="dialog__header">'
    ...
    +'<div class="table__container">'
      +'<div class="table__thead row">'
        ...
        +'<div class="table__th col-xs-2">ICD-O-3 Term</div>'
        +'{{else}}'
        +'<div class="table__th col-xs-6">GDC Term</div>'
        +'{{/if}}'
        +'<div class="table__th col-xs-2">NCIt Code</div>'
        +'<div class="table__th col-xs-4">NCIt Terms</div>'
      +'</div>'
    +'</div>'
  +'</div>',
            ...
            +'{{if e === true || ~root.targets === null}}'
              +'<div class="table__row row">'
                +'{{if ~root.icdo}}'
                  ...
                  +'<div class="table__td col-xs-2">{{if i_c}}{{if i_c.n}}{{:i_c.n}}{{else}}{{:n}}{{/if}}{{/if}}</div>'
                +'{{else}}'
                  +'<div class="table__td col-xs-6">{{:n}}</div>'
                +'{{/if}}'
                +'<div class="table__td col-xs-2">'
                  ...
                  +'{{/if}}'
                +'</div>'
                +'<div name="syn_area" class="table__td col-xs-4">{{for s_r}}{{>#data}}<br>{{/for}}</div>'
