              ...
              +'{{for items}}'
                +'{{if n == ~root.target }}'
                  +'<div class="table__row row" id="gdc_data_match">'
                    +'<div class="table__td table__td--slim col-xs-4">{{if i_c}}{{:i_c.c}}{{/if}}</div><div class="table__td table__td--slim col-xs-8"><b>{{:n}}</b></div>'
                  +'</div>'
                +'{{else}}'
                  +'<div class="table__row row" style="display: none;">'
                    +'<div class="table__td table__td--slim col-xs-4">{{if i_c}}{{:i_c.c}}{{/if}}</div><div class="table__td table__td--slim col-xs-8">{{:n}}</div>'
                  +'</div>'
                +'{{/if}}'
              +'{{/for}}'
            +'{{else}}'
              ...
              +'{{for items}}'
                +'{{if n == ~root.target }}'
                  +'<div class="row" id="gdc_data_match">'
                    +'<div class="table__td table__td--xslim col-xs-12"><b>{{:n}}</b></div>'
                  +'</div>'
                +'{{else}}'
