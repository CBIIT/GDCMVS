              ...
              +'{{for items}}'
                +'{{if n == ~root.target }}'
                  +'<div class="table__row row" id="gdc_data_match">'
                    +'<div class="table__td table__td--slim col-xs-4"><b>{{:n}}</b></div>'
                    +'<div class="table__td table__td--slim col-xs-3">{{if i_c}}{{if n == i_c.c}}<b>{{:i_c.c}}</b>{{else}}{{:i_c.c}}{{/if}}{{/if}}</div>'
                    +'<div class="table__td table__td--slim col-xs-4">{{if i_c}}{{if i_c.n}}{{:i_c.n}}{{else}}<b>{{:n}}</b>{{/if}}{{/if}}</div>'
                  +'</div>'
                +'{{else}}'
                  +'<div class="table__row row" style="display: none;">'
                    ...
                    +'<div class="table__td table__td--slim col-xs-4">{{if i_c}}{{if i_c.n}}{{:i_c.n}}{{else}}{{:n}}{{/if}}{{/if}}</div>'
                  +'</div>'
                +'{{/if}}'
              +'{{/for}}'
            +'{{else}}'
